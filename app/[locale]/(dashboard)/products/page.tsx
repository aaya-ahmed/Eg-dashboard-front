    ...
    return (
        <>
            <section >
                ...
                {ShowForm && <ProductFormComponent setRefetch={SetRefetch} setData={SetSelectedData} setShowForm={SetShowForm} data={selectedData} />}
                {!ShowForm && <ProductListComponent setRefetch={SetRefetch} selectedData={selectedData} setSelectedData={SetSelectedData} refetch={refetch} />}
